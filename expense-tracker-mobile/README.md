...
*   **AI Suggestions**: View personalized financial insights and savings opportunities generated by AI.
...
*   **Payment Tracking**: 
    ...
    *   **Logic**: Strictly prevents marking as paid *before* the due date to ensure accurate history.
